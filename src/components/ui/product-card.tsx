  ...
  ({ className, categoryIcon, categoryLogoSrc, category, title, description, imageSrc, imageAlt, ...props }, ref) => {
    ...
    return (
      <motion.div
        ...
        className={cn(
          "relative h-[350px] w-[350px] rounded-2xl bg-white shadow-lg transition-shadow duration-300 hover:shadow-2xl",
          className
        )}
        {...props}
      >
        <div style={{ transform: "translateZ(20px)", transformStyle: "preserve-3d" }} className="absolute inset-4 rounded-xl bg-gray-50/50 shadow-inner">
          ...
          <motion.div
            ...
            style={{
              opacity: glowOpacity,
              background: `radial-gradient(80px at ${glowX}% ${glowY}%, rgba(12, 47, 30, 0.3), transparent 40%)`,
            }}
          />
